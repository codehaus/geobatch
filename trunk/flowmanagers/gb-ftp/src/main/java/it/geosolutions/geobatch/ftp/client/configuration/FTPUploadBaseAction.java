 ...
 * 
 */
public abstract class FTPUploadBaseAction<T extends EventObject> extends BaseAction<T>
        implements Action<T> {
	
    /**
     * Default logger
     */
    protected final static Logger LOGGER = Logger.getLogger(FTPUploadBaseAction.class.toString());
     ...
     * @throws IOException
     */
    public FTPUploadBaseAction(FTPUploadActionConfiguration configuration)
            throws IOException {
