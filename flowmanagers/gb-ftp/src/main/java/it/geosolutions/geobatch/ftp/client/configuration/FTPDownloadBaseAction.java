 ...
 * 
 */
public abstract class FTPDownloadBaseAction<T extends EventObject> extends BaseAction<T>
        implements Action<T> {
	
    /**
     * Default logger
     */
    protected final static Logger LOGGER = Logger.getLogger(FTPDownloadBaseAction.class.toString());

    protected final FTPDownloadActionConfiguration configuration;
     ...
     * @throws IOException
     */
    public FTPDownloadBaseAction(FTPDownloadActionConfiguration configuration)
            throws IOException {
